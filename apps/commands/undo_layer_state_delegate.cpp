...
bool UndoRedoLayerStateDelegate::_IsDirty() {
    return _dirty;
}

void UndoRedoLayerStateDelegate::_MarkCurrentStateAsClean() {
    _dirty = false;
}

void UndoRedoLayerStateDelegate::_MarkCurrentStateAsDirty() {
    _dirty = true;
}

void UndoRedoLayerStateDelegate::_OnSetLayer(const SdfLayerHandle &layer) {
    _layer = layer;
}
