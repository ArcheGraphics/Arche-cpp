...
[[nodiscard]] constexpr auto is_block_compressed(PixelStorage s) noexcept {
    return vox::to_underlying(s) >= vox::to_underlying(PixelStorage::BC1) &&
           vox::to_underlying(s) <= vox::to_underlying(PixelStorage::BC7);
}

[[nodiscard]] constexpr auto is_block_compressed(PixelFormat f) noexcept {
    return vox::to_underlying(f) >= vox::to_underlying(PixelFormat::BC1UNorm) &&
           vox::to_underlying(f) <= vox::to_underlying(PixelFormat::BC7UNorm);
}
