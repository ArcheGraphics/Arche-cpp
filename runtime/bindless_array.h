...
public:
    ...
    struct ModSlotHash {
        ...
        [[nodiscard]] auto operator()(Modification m) const noexcept {
            return hash_value(static_cast<size_t>(m.slot));
        }
    };
...
private:
    ...
    std::unordered_set<Modification, ModSlotHash, ModSlotEqual> _updates;
...
public:
    ...
    [[nodiscard]] std::unique_ptr<Command> update() noexcept;
