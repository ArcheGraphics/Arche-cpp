...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens,
    // Shading node IDs
    (UsdPreviewSurface)(UsdUVTexture)(UsdPrimvarReader_float2)(UsdTransform2d)
    // UsdPreviewSurface inputs
    (emissiveColor)(occlusion)(normal)(opacityThreshold)(diffuseColor)(opacity)(metallic)(roughness)(clearcoat)(clearcoatRoughness)(ior)(specularColor)(useSpecularWorkflow)
    // UsdUVTexture inputs
    (st)(file)(scale)(bias)(fallback)(wrapS)(wrapT)(sourceColorSpace)
